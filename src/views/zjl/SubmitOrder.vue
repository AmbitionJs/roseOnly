      ...
      <el-row class="messages">
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <p>送礼物前别忘了为收礼人留下你的专属真爱誓言！
            扫码关注，下单后通过语音或文字的形式提交内容，
            收礼人可随时查阅，感受独一无二的专属爱语。</p>
          </div>
        </el-col>
        <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    submitOrder() {
      ...
      this.submitOrderList.orderDetailId,this.submitOrderList.orderDetailNo,this.radio,this.submitOrderList.trolleyId,this.message,
      this.deliveryTime)
      ...
      // }).then(res => { console.log('提交成功', res)}).catch(err => { console.log("提交失败", err)})
    }
  },
  // 请求数据
  created() {

        ...
        <form >
            ...
            <div class="tele-number clear" ref="borderChang">
                ...
                <div class="tele-input">
                    <input type="text" placeholder="请输入手机号" @focus="telFocus" @blur ="telBlur" v-model="username" ref ="tel">
                </div>
            </div>
            <!-- 验证手机号 -->
            ...
            <!-- 输入密码 -->
            <div class="pass">
                <input type="password" placeholder="请输入密码" v-model="userpass" @blur="passBlur" ref="passInput">
            </div>
            <!-- 验证密码 -->
